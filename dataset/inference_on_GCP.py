...
image_path =sys.argv[1] #"project_video.mp4" 
...
images = detect_video(yolo,image_path, sys.argv[2], input_size=input_size, show=False, CLASSES=YOLO_COCO_CLASSES, rectangle_colors='')
